...
GOFLAGS=-ldflags "-X github.com/ChichiuLiang/device-sdk-go/v2.Version=$(VERSION)" -trimpath -mod=readonly
CGOFLAGS=-ldflags "-linkmode=external -X github.com/ChichiuLiang/device-sdk-go/v2.Version=$(VERSION)" -trimpath -mod=readonly -buildmode=pie
GOTESTFLAGS?=-race
